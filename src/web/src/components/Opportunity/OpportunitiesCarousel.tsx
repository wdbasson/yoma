...
export const OpportunitiesCarousel: React.FC<{
  ...
  const onChange = useCallback(
    async (index: number) => {
      ...
      // console.warn(
      //   `START: index: ${index} isLoadingData: ${isLoadingDataRef.current} cache: ${cache.length} startRow: ${startRow} nextStartRow: ${nextStartRow}`,
      // );
      ...
      // fetch more data
      //console.warn(`FETCHING DATA... nextStartRow: ${nextStartRow}`);
