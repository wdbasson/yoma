...
INSERT INTO [entity].[Organization]([Id],[Name],[WebsiteURL],[PrimaryContactName],[PrimaryContactEmail],[PrimaryContactPhone],[VATIN],[TaxNumber]
           ,[RegistrationNumber],[City],[CountryId],[StreetAddress],[Province],[PostalCode],[Tagline],[Biography],[Approved],[DateApproved]
...
NULL, NULL, '0EFB07E6-6634-46DE-A98D-A85BF331C20E', NULL, NULL, NULL, NULL, NULL, 1, GETDATE(), 1, NULL, NULL,NULL,GETDATE(), GETDATE())
GO
