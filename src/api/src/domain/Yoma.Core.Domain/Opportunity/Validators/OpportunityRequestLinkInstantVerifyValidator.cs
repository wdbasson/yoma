...
{
  public class OpportunityRequestLinkInstantVerifyValidator : AbstractValidator<OpportunityRequestLinkInstantVerify>
  {
    #region Public Members
    public OpportunityRequestLinkInstantVerifyValidator()
    {
