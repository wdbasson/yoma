...
VALUES(gen_random_uuid(),
    ...
    CAST(CURRENT_DATE - INTERVAL '10 days' AS TIMESTAMP) AT TIME ZONE 'UTC',
    CAST(CAST(CURRENT_DATE + INTERVAL '2 months' AS TIMESTAMP) + INTERVAL '1 DAY' - INTERVAL '1 millisecond' AS TIMESTAMP) AT TIME ZONE 'UTC',
    true,
    'Opportunity|Default',
    (CURRENT_TIMESTAMP AT TIME ZONE 'UTC'),
    (SELECT "Id" FROM "Entity"."User" WHERE "Email" = '{org_admin_user}'),
